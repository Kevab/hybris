 ...
 *  
 */
package en.hybris.platform.jalo;
...
import en.hybris.platform.constants.CyclientConstants;



/**
 * This is the extension manager of the Cyclient extension.
 */
public class CyclientManager extends GeneratedCyclientManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CyclientManager.class.getName());
	 ...
	 */
	public static CyclientManager getInstance()
	{
		return (CyclientManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CyclientConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclientManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CyclientManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CyclientManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CyclientManager called, current tenant: " + getTenant().getTenantID());
		}
	}
